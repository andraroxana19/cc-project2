...
export default function InsertPage() {
	...
	return (
		<section className={"bg-white"}>
				...
				<form>
						<div className="mb-2 px-10 py-10">
							<label htmlFor="email" className="font-bold  text-5xl block mb-2 text-sm font-large text-gray-900 dark:text-black">Pizza name</label>
						...
						<div className="mb-6 px-10">
							<label htmlFor="number" className="font-bold  text-5xl  block mb-2 text-sm font-medium text-gray-900 dark:text-black">Size</label>
						...
						<div className="mb-6 px-10">
							<label htmlFor="number" className="font-bold  text-5xl  block mb-2 text-sm font-medium text-gray-900 dark:text-black">Quantity</label>
						...
						<div className="mb-40 px-10">
							<label htmlFor="description"
								className="block mb-2 font-bold  text-5xl text-sm font-medium text-gray-900 dark:text-black">Your contact</label>
						...
						<button type="submit "
								...
								className="text-white py-30 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-large rounded-lg text-sm w-full text-5xl sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit Order
						</button>
					</form>
